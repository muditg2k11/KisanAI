      ...
      <div id="pxl-page" className="pxl-page header-pos-df">
        ...
        <div style={formStyles.wrapper}>
          <div style={formStyles.card}>
            ...
            <h2 style={formStyles.title}>Welcome Back</h2>
            <p style={formStyles.subtitle}>Sign in to your Agrinova account</p>
            ...
            <p style={formStyles.link}>
              ...
              <a href="/register" style={formStyles.linkA}>Register here</a>
            </p>
          </div>
        </div>
        <Footer />
